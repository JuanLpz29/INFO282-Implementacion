      ...
      <template v-slot:body="props">
        ...
        <q-tr :props="props">
          ...
          <q-td key="categoria" :props="props">
            {{ props.row.categoria }}
            <q-popup-edit v-model="props.row.categoria" title="Update categoria" buttons>
              <q-input type="textarea" v-model="props.row.categoria" dense autofocus />
            </q-popup-edit>
          </q-td> 

            <q-td key="stock" :props="props">
            {{ props.row.stock }}
            <q-popup-edit v-model="props.row.stock" title="Update stock" buttons persistent>
              <q-input type="number" v-model="props.row.stock" dense autofocus hint="Use buttons to close" />
            </q-popup-edit>
          </q-td>
          ...
          <q-td key="descripcion" :props="props">
            ...
            <q-popup-edit v-model="props.row.descripcion">
              <q-input type="textarea" v-model="props.row.descripcion" dense autofocus />
            </q-popup-edit>
          </q-td>
