const Scanner = () => {
    ...
    Scanner.getPreviousCode = () => {
        return attributes.previousCode
    }

    Scanner.setSensitivity = (sensitivity) => {
...
const VueScanner = Scanner();

export default {
    install(app, options = {}) {
        console.log('install plugin scanner')
        const global = app.config.globalProperties;
        global.$barcodeScanner = VueScanner(options);
        app.provide('BarcodeScanner', VueScanner);
    },
};
